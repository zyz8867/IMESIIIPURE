...
public class Hr_mine extends Ac_base_query implements Frg_dialog.Callback{
    ...
    @OnClick({R.id.hr_cus_hotel})
    public void hotel_onClick(View view) {
    ...
    private void Handle_hotel(int i){
        ...
        if(i == 0){
                    ...
                    .setItems(strings, new SuperDialog.OnItemClickListener() {
                        ...
                        public void onItemClick(int position) {
                            ...
                            if(position == 0){
                                ...
                                hopToActivity(Hr_Likelist_Detail.class, bundle);
                                finish();
            ...
            System.out.println(hotel_array.size());
            if(hotel_array != null){
                hotels.clear();
                ...
                HotelAdapter adapter = new HotelAdapter(Hr_mine.this, R.layout.hr_customer_hotel_item, hotels);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentLayout(R.layout.hr_cus_mine);
        showToolBar(false);
...
//                finish();
        ...
        Likelist1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
                ...
                Thread thread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            hotel_array = Util.like_list(conn, username);
                            if(hotel_array!=null){
