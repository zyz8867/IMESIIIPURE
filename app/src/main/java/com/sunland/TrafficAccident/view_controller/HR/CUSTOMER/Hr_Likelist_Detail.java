...
public class Hr_Likelist_Detail extends Ac_base_query implements Frg_dialog.Callback{
    ...
    private void Handle_hotel(int i){
        ...
        if(i == 0){
            ...
            dialogUtils.showDialog(Hr_Likelist_Detail.this, "Paying", DialogUtils.TYPE_PROGRESS, new DialogUtils.OnCancelClickListener() {
                @Override
            ...
            dialogUtils.showDialog(Hr_Likelist_Detail.this, "Like", DialogUtils.TYPE_PROGRESS, new DialogUtils.OnCancelClickListener() {
                @Override
                public void onCancel() {
                    //mRequestManager.cancelAll();
                    dialogUtils.dialogDismiss();
                    ...
                    Thread thread = new Thread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                int i = Util.delete_from_like_list(conn,username, HOTELNAME,ROOMTYPE);
                                // 0：收藏成功，1：连接错误
                                mHandler.sendEmptyMessage(i);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentLayout(R.layout.hr_cus_likelist);
        showToolBar(false);
        ...
        datePicker.init(year, month, day, new DatePicker.OnDateChangedListener() {
            ...
            public void onDateChanged(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                //获取选中的年月日
                Hr_Likelist_Detail.this.year = year;
                //月份是从0开始的
                Hr_Likelist_Detail.this.month = (monthOfYear+1);
                Hr_Likelist_Detail.this.day = dayOfMonth;
                //弹窗显示
                dd = Hr_Likelist_Detail.this.year+"-"+ Hr_Likelist_Detail.this.month+"-"+Hr_Likelist_Detail.this.day;
